...
**Thuật toán:**
- B1: đọc marker cache trong .agent/agents/personas/tu-ma-y-agent/user-context-files/system/user.md.
...
1. .agent/agents/personas/tu-ma-y-agent/agent.json
2. .agent/agents/personas/tu-ma-y-agent/context-files/identity.md
3. .agent/agents/personas/tu-ma-y-agent/context-files/soul.md
4. .agent/agents/personas/tu-ma-y-agent/context-files/agents.md
5. .agent/agents/personas/tu-ma-y-agent/context-files/user-predefined.md
6. .agent/agents/personas/tu-ma-y-agent/user-context-files/system/user.md
7. .agent/agents/personas/tu-ma-y-agent/user-context-files/system/bootstrap.md (chỉ khi thiếu user context)
### EN
**Goal:** load context session-aware to reduce token cost while preserving correctness.
**Algorithm:**
- S1: read cache marker in .agent/agents/personas/tu-ma-y-agent/user-context-files/system/user.md.
...
5. .agent/agents/personas/tu-ma-y-agent/context-files/user-predefined.md
6. .agent/agents/personas/tu-ma-y-agent/user-context-files/system/user.md
7. .agent/agents/personas/tu-ma-y-agent/user-context-files/system/bootstrap.md (only if user context is missing)
## 1) Quick Start
### VI
| Mục | Nội dung |
|---|---|
...
- .agent/agents/personas/tu-ma-y-agent/context-files/identity.md
...
### VI
Gợi ý các lệnh Slash phù hợp với vai trò của **Tư Mã Ý**:
- **/debug**: Chế độ gỡ lỗi cẩn trọng.
- **/status**: Đánh giá rủi ro và tiến độ.
- **/plan**: Lập kế hoạch khả thi cao.
- **/rules-distill**: Chắt lọc quy tắc và bảo mật.
### EN
Suggested Slash commands aligned with **Tu Ma Y**'s role:
- **/debug**: Cautious debugging.
- **/status**: Risk and progress evaluation.
- **/plan**: High-feasibility planning.
- **/rules-distill**: Distilling rules and security measures.
