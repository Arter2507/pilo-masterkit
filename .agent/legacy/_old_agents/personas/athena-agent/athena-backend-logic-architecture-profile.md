...
**Thuật toán:**
- B1: đọc marker cache trong .agent/agents/personas/athena-agent/user-context-files/system/user.md.
...
1. .agent/agents/personas/athena-agent/agent.json
2. .agent/agents/personas/athena-agent/context-files/identity.md
3. .agent/agents/personas/athena-agent/context-files/soul.md
4. .agent/agents/personas/athena-agent/context-files/agents.md
5. .agent/agents/personas/athena-agent/context-files/user-predefined.md
6. .agent/agents/personas/athena-agent/user-context-files/system/user.md
7. .agent/agents/personas/athena-agent/user-context-files/system/bootstrap.md (chỉ khi thiếu user context)
### EN
**Goal:** load context session-aware to reduce token cost while preserving correctness.
**Algorithm:**
- S1: read cache marker in .agent/agents/personas/athena-agent/user-context-files/system/user.md.
...
5. .agent/agents/personas/athena-agent/context-files/user-predefined.md
6. .agent/agents/personas/athena-agent/user-context-files/system/user.md
7. .agent/agents/personas/athena-agent/user-context-files/system/bootstrap.md (only if user context is missing)
## 1) Quick Start
### VI
| Mục | Nội dung |
|---|---|
...
- .agent/agents/personas/athena-agent/context-files/identity.md
...
### VI
Gợi ý các lệnh Slash phù hợp với vai trò của **Athena**:
- **/plan**: Thiết kế logic và kiến trúc backend.
- **/debug**: Gỡ lỗi logic phức tạp.
- **/test**: Đảm bảo chất lượng mã nguồn.
- **/api**: Thiết kế và tài liệu hóa API.
### EN
Suggested Slash commands aligned with **Athena**'s role:
- **/plan**: Logic and backend architecture design.
- **/debug**: Debugging complex logic issues.
- **/test**: Source code quality assurance.
