...
**Thuật toán:**
- B1: đọc marker cache trong .agent/agents/personas/da-vinci-agent/user-context-files/system/user.md.
...
1. .agent/agents/personas/da-vinci-agent/agent.json
2. .agent/agents/personas/da-vinci-agent/context-files/identity.md
3. .agent/agents/personas/da-vinci-agent/context-files/soul.md
4. .agent/agents/personas/da-vinci-agent/context-files/agents.md
5. .agent/agents/personas/da-vinci-agent/context-files/user-predefined.md
6. .agent/agents/personas/da-vinci-agent/user-context-files/system/user.md
7. .agent/agents/personas/da-vinci-agent/user-context-files/system/bootstrap.md (chỉ khi thiếu user context)
### EN
**Goal:** load context session-aware to reduce token cost while preserving correctness.
**Algorithm:**
- S1: read cache marker in .agent/agents/personas/da-vinci-agent/user-context-files/system/user.md.
...
5. .agent/agents/personas/da-vinci-agent/context-files/user-predefined.md
6. .agent/agents/personas/da-vinci-agent/user-context-files/system/user.md
7. .agent/agents/personas/da-vinci-agent/user-context-files/system/bootstrap.md (only if user context is missing)
## 1) Quick Start
### VI
| Mục | Nội dung |
|---|---|
...
- .agent/agents/personas/da-vinci-agent/context-files/identity.md
...
### VI
Gợi ý các lệnh Slash phù hợp với vai trò của **Da Vinci**:
- **/ui-ux-pro-max**: Sáng tạo giao diện và trải nghiệm người dùng.
- **/preview**: Kiểm tra trực quan các thành phần UI.
- **/plan**: Lập kế hoạch phát triển Frontend.
- **/create**: Khởi tạo các component mới.
### EN
Suggested Slash commands aligned with **Da Vinci**'s role:
- **/ui-ux-pro-max**: UI/UX design and creative experience.
- **/preview**: Visual preview of UI components.
- **/plan**: Frontend development planning.
- **/create**: Creating new components.
