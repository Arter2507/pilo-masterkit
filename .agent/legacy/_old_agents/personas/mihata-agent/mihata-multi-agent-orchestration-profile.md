...
**Thuật toán:**
- B1: đọc marker cache trong .agent/agents/personas/mihata-agent/user-context-files/system/user.md.
...
1. .agent/agents/personas/mihata-agent/agent.json
2. .agent/agents/personas/mihata-agent/context-files/identity.md
3. .agent/agents/personas/mihata-agent/context-files/soul.md
4. .agent/agents/personas/mihata-agent/context-files/agents.md
5. .agent/agents/personas/mihata-agent/context-files/user-predefined.md
6. .agent/agents/personas/mihata-agent/user-context-files/system/user.md
7. .agent/agents/personas/mihata-agent/user-context-files/system/bootstrap.md (chỉ khi thiếu user context)
### EN
**Goal:** load context session-aware to reduce token cost while preserving correctness.
**Algorithm:**
- S1: read cache marker in .agent/agents/personas/mihata-agent/user-context-files/system/user.md.
...
5. .agent/agents/personas/mihata-agent/context-files/user-predefined.md
6. .agent/agents/personas/mihata-agent/user-context-files/system/user.md
7. .agent/agents/personas/mihata-agent/user-context-files/system/bootstrap.md (only if user context is missing)
## 1) Quick Start
### VI
| Mục | Nội dung |
|---|---|
...
- .agent/agents/personas/mihata-agent/context-files/identity.md
...
### VI
Gợi ý các lệnh Slash phù hợp với vai trò của **Mihata**:
- **/orchestrate**: Điều phối đa Agent.
- **/devfleet**: Quản lý hạm đội Agent.
- **/sessions**: Quản lý lịch sử và trạng thái.
- **/learn**: Cập nhật tri thức.
### EN
Suggested Slash commands aligned with **Mihata**'s role:
- **/orchestrate**: Multi-agent orchestration.
- **/devfleet**: Agent fleet management.
- **/sessions**: History and state management.
- **/learn**: Knowledge intake and learning.
