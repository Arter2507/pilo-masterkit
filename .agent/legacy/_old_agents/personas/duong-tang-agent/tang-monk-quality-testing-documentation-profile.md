...
**Thuật toán:**
- B1: đọc marker cache trong .agent/agents/personas/duong-tang-agent/user-context-files/system/user.md.
...
1. .agent/agents/personas/duong-tang-agent/agent.json
2. .agent/agents/personas/duong-tang-agent/context-files/identity.md
3. .agent/agents/personas/duong-tang-agent/context-files/soul.md
4. .agent/agents/personas/duong-tang-agent/context-files/agents.md
5. .agent/agents/personas/duong-tang-agent/context-files/user-predefined.md
6. .agent/agents/personas/duong-tang-agent/user-context-files/system/user.md
7. .agent/agents/personas/duong-tang-agent/user-context-files/system/bootstrap.md (chỉ khi thiếu user context)
### EN
**Goal:** load context session-aware to reduce token cost while preserving correctness.
**Algorithm:**
- S1: read cache marker in .agent/agents/personas/duong-tang-agent/user-context-files/system/user.md.
...
5. .agent/agents/personas/duong-tang-agent/context-files/user-predefined.md
6. .agent/agents/personas/duong-tang-agent/user-context-files/system/user.md
7. .agent/agents/personas/duong-tang-agent/user-context-files/system/bootstrap.md (only if user context is missing)
## 1) Quick Start
### VI
| Mục | Nội dung |
|---|---|
...
- .agent/agents/personas/duong-tang-agent/context-files/identity.md
...
### VI
Gợi ý các lệnh Slash phù hợp với vai trò của **Đường Tăng**: 
- **/test**: Kiểm tra chất lượng và độ bao phủ.
- **/code-review**: Đánh giá mã nguồn.
- **/docs**: Tìm kiếm tri thức.
- **/init-docs**: Khởi tạo hệ thống tài liệu.
### EN
Suggested Slash commands aligned with **Duong Tang**'s role:
- **/test**: Quality and coverage assessment.
- **/code-review**: Code review.
- **/docs**: Knowledge search.
- **/init-docs**: Documentation systems initialization.
